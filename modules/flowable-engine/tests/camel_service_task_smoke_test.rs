...
fn deploy_xml(
    ...
    let builder = repository_service
        .create_deployment()
        .name("Camel Service Task Test".to_string())
...
#[test]
fn camel_service_task_deploy_succeeds_with_valid_bpmn() {
    ...
    <definitions xmlns="http://www.omg.org/spec/BPMN/20100524/MODEL"
        ...
        <process id="camelProcess">
            ...
            <sequenceFlow id="flow1" sourceRef="startEvent1" targetRef="camelTask1" />
            <serviceTask id="camelTask1" flowable:type="camel" />
            <sequenceFlow id="flow2" sourceRef="camelTask1" targetRef="endEvent1" />
    ...
    assert!(
        result.is_ok(),
        "Camel service task should deploy (runtime behavior is separate)"
    );
}
